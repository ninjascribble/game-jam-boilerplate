...
export default class Menu extends Scene {
  ...
  titleText () {
    return DisplayObjects.displayFont(this, 'THIS IS THE MENU', this.cameras.main.centerX, 100, 'center');
  }
...
!№;%:?*()_+-=.,/|"'@#$^&{}[]`, this.cameras.main.centerX, 145, 'center');
    text.maxWidth = 300;
    return text;
  }

  actionText () {
    var text = DisplayObjects.bodyFont(this, 'Press Spacebar to Play!', this.cameras.main.centerX, 190, 'center');
    this.time.addEvent({
      loop: true,
      delay: 400,
